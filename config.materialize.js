export const config = {
  pages: [
    ...
    { id: "gantt", url: "gantt.html", name: "Gantt", description: "Plan projects with a Material timeline, task progress, and milestones." },
    ...
    { id: "timeline", url: "timeline.html", name: "Timeline", description: "Present milestones, activity, and stories with a responsive Material timeline." },
