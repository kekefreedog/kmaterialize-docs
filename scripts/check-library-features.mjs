...
const required = ['TinyNavbar', 'NavbarAutoHide', 'Gantt', 'Editor', 'CrazyLoading', 'CrazyButton', 'Kmcomponent', 'OrgChart', 'initMaterialButtons', 'initListChecklist', 'enableCardHandles', 'RichTextarea', 'OtpInput', 'MaskitoInput', 'initNavbarScroll'];
...
for (const selector of ['.footer-layout', '.footer-fixed', '.timeline', '.timeline-event', '.timeline-content', '.timeline-badge', '.timeline-left', '.navbar-tiny', '.navbar-hide-on-scroll', '.editor-workspace', '.switch-with-icon', '.tabs-fill', '.radio-group-horizontal', '.m3-rail', '.navbar-scroll', '.navbar-search-toolbar', '.rich-textarea', '.otp-input-slot']) {
