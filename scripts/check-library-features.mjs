...
const required = ['Editor', 'CrazyLoading', 'CrazyButton', 'Kmcomponent', 'OrgChart', 'initMaterialButtons', 'initListChecklist', 'enableCardHandles', 'RichTextarea', 'OtpInput', 'MaskitoInput', 'initNavbarScroll'];
...
for (const selector of ['.editor-workspace', '.switch-with-icon', '.tabs-fill', '.radio-group-horizontal', '.m3-rail', '.navbar-scroll', '.navbar-search-toolbar', '.rich-textarea', '.otp-input-slot']) {
